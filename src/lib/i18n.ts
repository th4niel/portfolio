...
export const messages = {
  en: {
    ...
    home: {
      ...
      description: "Hi, I'm {name} — {role}, currently in my 4th year studying Information Management at Kunshan University, Tainan, Taiwan. I'm passionate about {industry} and {field}.",
  ...
  'zh-TW': {
    ...
    home: {
      ...
      subtitle1: "我是全端工程師",
      subtitle2: "我是大學生",
      description: "您好，我是 {name} — {role}，目前就讀台南崑山科技大學資訊管理系四年級。對{industry} 與 {field} 領域充滿熱忱。",
      name: "Nathaniel Edwin",
      role: "全端工程師",
      industry: "金融科技產業",
      field: "行動應用開發", 
